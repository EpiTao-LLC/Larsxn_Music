...
const DemosSectionPlayer = (
    ...
    console.log ("DemoSectionPlayer", player)
...
const createDemosSlideHeader = (titleName, player) => {
    console.log ("DemoSectionSlideHeader", player)
    return (
...
const DemosSectionCarouselContainer = (
    {title, appContext, player, setPlayer, playerRef}) => {
    ...
    console.log('Container Player', playerRef.current)
    ...
    return (
        ...
        <Carousel id="demo-carousel"
            ...
            <Carousel.Item>
                {createDemosSlideHeader(titlesList[0],player)}
            ...
            <Carousel.Item>
                {createDemosSlideHeader(titlesList[1],player)}
            ...
            <Carousel.Item>
                {createDemosSlideHeader(titlesList[2], player)}
            ...
            <Carousel.Item>
                {createDemosSlideHeader(titlesList[3], player)}
