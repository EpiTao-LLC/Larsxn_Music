...
this.context.otherPlayer = createRef()
console.log('otherPlayer', this.context.otherPlayer)

function stopOtherPlayer (currentPlayer) {
    console.log('1st current=',currentPlayer, 'other', this.context.otherPlayer)
    if (this.context.otherPlayer == null) {
        this.context.otherPlayer = currentPlayer
        // global.otherPlayer.current.audio.current.pause()
    }
    this.context.otherPlayer = currentPlayer
    // currentPlayer.current.audio.current.pause()
    console.log('2nd current=',currentPlayer, 'other', this.context.otherPlayer)
}
