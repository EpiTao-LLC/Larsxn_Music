...
const Layout = ({appContext}) => {
  ...
  const instanceTitles = titles
  console.log('instanceTitles', instanceTitles)
  const curTitle = instanceTitles.find(titles => titles.titleName === context.title)
  const artistList = artists.filter(artist => artist.titleName === context.title)
