...
const Header = (
  {titleName, cover, coverArt, alt, appContext}
    ...
    function handleClick (title, artistsPage) {
        ...
        alert alert('handleClick', title, artistsPage)
        try {
        appContext.setContext({title: title, artistPage: artistsPage})
        }
        catch (err) { console.log (err)}
        console.log('setContext', appContext.context)
        alert('handleClick', title, artistsPage)
        return (appContext)
    }

    let title = appContext.title
              ...
              <NavDropdown.Item as="li" className='nav-item dropdown-item'>
                ...
                <a href = "/Layout" className='nav-item dropdown-item'
                  onClick={(e) => {
                    ...
                    alert('context', appContext.context)
