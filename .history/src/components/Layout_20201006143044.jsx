...
const Layout = (props) => {
  ...
  let curTitle = titles.find(titles => titles.titleName === props.appContext.title);
  let artistList = artists.filter(artist => artist.titleName === props.appContext.title);
  ...
  return (
    <div>
      <Header
        ...
        />
      {appContext.artistContext.artistsPage &&
