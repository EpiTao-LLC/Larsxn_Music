    ...
    return (
        ...
        <Carousel id="demo-carousel"
            ...
            <Carousel.Item>
                ...
                <Link to = "/components/ArtistsLayoutContainer" className='artist-link'
                  activeClassName="active" state={{titleName: titlesList[0].titleName}}>Artists</Link>
            </Carousel.Item>
            <Carousel.Item>
                {createDemosSlideHeader(titlesList[1])}
                {createDemosSongs(titlesList[1])}
                <Link to = "/components/ArtistsLayoutContainer"
                  onClick={() => {trackingCall(titlesList[1].titleName + " Artists")}}
                  className='artist-link'
                  activeClassName="active" state={{titleName: titlesList[1].titleName}}>Artists</Link>
            </Carousel.Item>
        </Carousel>
        </div>
        </section>
